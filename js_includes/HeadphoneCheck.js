...
(function(HeadphoneCheck, $, undefined) {
  ...
  HeadphoneCheck.renderHeadphoneCheckPage = function() {
    ...
    $('<div/>', {
      ...
      html: 'There are six trials in this sound test. <br/> <br/> For each trial, press <b>Play</b> to hear three sounds separated by silences.'
  ...
  function renderHeadphoneCheckTrial(stimDiv, stimID, stimFile) {
    ...
    var radioButtonInfo = [
                            {'id': '1', 'name': 'FIRST sound was <b>SOFTEST</b>'},
                            {'id': '2', 'name': 'SECOND sound was <b>SOFTEST</b>'},
                            {'id': '3', 'name': 'THIRD sound was <b>SOFTEST</b>'},
                          ];
